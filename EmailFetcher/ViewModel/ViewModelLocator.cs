...
using DeveloperTest.Services.Helpers.Implementations;
...
namespace DeveloperTest.ViewModel
{
    ...
    public class ViewModelLocator
    {
        ...
        public ViewModelLocator()
        {
            ...
            SimpleIoc.Default.Register<IUser, User>();
            SimpleIoc.Default.Register<IEmailClientFactory, EmailClientFactory>();
            SimpleIoc.Default.Register<IEmailManager, EmailManager>();
